...
import {getContract, AUTHENTICITY_ADDRESS, stringToFelt252, felt252ToString} from '../lib/blockchain';
import {getTypedData} from '../lib/certificateData';
import {parseError, handleError} from '../lib/errorParser';
